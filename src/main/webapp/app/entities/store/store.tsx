  ...
  return (
    <div>
      <h2 id="store-heading" data-cy="StoreHeading">
        <Translate contentKey="cardperksApp.store.home.title">Stores</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="cardperksApp.store.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/store/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="cardperksApp.store.home.createLabel">Create new Store</Translate>
          </Link>
        </div>
      </h2>
        ...
        {storeList && storeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="cardperksApp.store.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="cardperksApp.store.name">Name</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                <th>
                  <Translate contentKey="cardperksApp.store.perk">Perk</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="cardperksApp.store.home.notFound">No Stores found</Translate>
            </div>
          )
        )}
      </div>
