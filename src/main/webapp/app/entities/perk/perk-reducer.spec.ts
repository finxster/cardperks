...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './perk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERK_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERK actions', async () => {
      const expectedActions = [
        {
