...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './card.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARD_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARD actions', async () => {
      const expectedActions = [
        {
