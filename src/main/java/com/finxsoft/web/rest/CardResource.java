...
import com.finxsoft.service.CardService;
...
/**
 * REST controller for managing {@link com.finxsoft.domain.Card}.
 */
@RestController
...
public class CardResource {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<CardDTO> updateCard(@PathVariable(value = "id", required = false) final Long id, @RequestBody CardDTO cardDTO)
