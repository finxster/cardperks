...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './store.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STORE actions', async () => {
      const expectedActions = [
        {
