...
export const StoreDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/store' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="cardperksApp.store.delete.question">
        <Translate contentKey="cardperksApp.store.delete.question" interpolate={{ id: storeEntity.id }}>
